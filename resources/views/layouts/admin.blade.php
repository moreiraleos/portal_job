...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route("admins.categories") }}" style="margin-left: 20px;">Categories</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route("admin.jobs") }}" style="margin-left: 20px;">Jobs</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route("admin.apps") }}" style="margin-left: 20px;">Applications</a>
          </li> 
        </ul>
        @endauth
