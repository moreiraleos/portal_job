...
<body>
    <div id="app">
        <!-- NAVBAR -->
        <header id="top" class="site-navbar mt-3">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="site-logo col-6"><a href="{{ url('/home') }}">JobBoard</a></div>
                    <nav class="mx-auto site-navigation">
                        <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                            <li style="padding-left: 244;"><a href="{{ url("/home") }}" class="nav-link active">Home</a></li>
                            ...
                            <li class="nav-item dropdown">
                                <button style="background-color: transparent;border: none;color: #EEE;" class="nav-link dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    {{ Auth::user()->name }}
                                </button>
